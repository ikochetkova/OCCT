...
Standard_Boolean TDataXtd_Geometry::Placement(const TDF_Label& theL, gp_Ax3& theAx)
{
  gp_Pnt                     aLoc;
  ...
  theAx.SetLocation(aLoc);
  theAx.SetDirection(gp_Dir(anArrayAttr->Value(1), anArrayAttr->Value(2), anArrayAttr->Value(3)));
  theAx.SetXDirection(gp_Dir(anArrayAttr->Value(4), anArrayAttr->Value(5), anArrayAttr->Value(6)));
  theAx.SetYDirection(gp_Dir(anArrayAttr->Value(7), anArrayAttr->Value(8), anArrayAttr->Value(9)));
  return Standard_True;
}
